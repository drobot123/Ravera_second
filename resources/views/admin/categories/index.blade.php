...
<div class="card-header">
<div class="d-flex">
  <div class="p-2"><p style="margin-bottom: 0rem; background: #323463;padding: 10px 45px;border-radius: 20px;">{{ trans('cruds.category.title_singular') }} {{ trans('global.list') }}
    
</div>
  {{-- <div class="p-2">Описание</div> --}}
  <div class="ml-auto p-2">@can('category_create')<a class="btn btn-success" href="{{ route("admin.categories.create") }}">
